...
public class TitleRenderer extends AbstractStateRenderer {

	public TitleRenderer(@Nonnull RendererState resources, @Nonnull UISettings settings, @Nonnull UIResourceManager resman,
